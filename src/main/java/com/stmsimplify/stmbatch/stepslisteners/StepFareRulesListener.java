...
import com.stmsimplify.stmbatch.fieldsmappers.FareRulesFieldSetMapper;
...
@Slf4j
@Component
public class StepFareRulesListener implements StepExecutionListener {

    private static final String FILENAME = "fare_rules.csv";
    private static final String DELIMITER = ",";
    private static final String[] FIELD_NAMES = new String[]{"fareId","routeId","originId","destinationId","containId"};

    @Override
    public void beforeStep(StepExecution stepExecution) {
        log.info("Fare Rules listener step call");
        ...
        stepExecution.getExecutionContext().put("fieldSetMapper", new FareRulesFieldSetMapper());
    }
